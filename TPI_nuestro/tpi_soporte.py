                ...
                if abs(thumb_tip[1] - index_finger_pip[1]) <45 \
                   ...
                   cv2.putText(image, 'G', (700, 150), 
                    ...
                    cv2.putText(image, 'F', (700, 150), 
                     ...
                     distancia_euclidiana(thumb_tip, middle_finger_tip) < 60: # Pulgar cerca del dedo medio
                    cv2.putText(image, 'G', (700, 150), 
                                cv2.FONT_HERSHEY_SIMPLEX, 
                                3.0, (0, 0, 255), 6)
                elif index_finger_tip[1] < index_finger_pip[1] and \
                     ...
                     distancia_euclidiana(thumb_tip, ring_finger_tip) < 60 and \
                    ...
                    cv2.putText(image, 'U', (700, 150), 
                     ...
                     middle_finger_tip[1] > middle_finger_pip[1] and \
                     ring_finger_tip[1] > ring_finger_pip[1] and \
                     distancia_euclidiana(thumb_tip, index_finger_tip) > 70: # Asegurar que el pulgar no esté extendido con el meñique
                    cv2.putText(image, 'I', (700, 150), 
                                cv2.FONT_HERSHEY_SIMPLEX, 
                                3.0, (0, 0, 255), 6)
                elif distancia_euclidiana(thumb_tip, index_finger_tip) < 60 and \
                     distancia_euclidiana(index_finger_tip, middle_finger_tip) < 60 and \
                     distancia_euclidiana(middle_finger_tip, ring_finger_tip) < 60 and \
                     distancia_euclidiana(ring_finger_tip, pinky_tip) < 60 and \
                     distancia_euclidiana(pinky_tip, thumb_tip) < 60 and \
                     thumb_tip[1] > index_finger_pip[1] : # Pulgar por debajo del nudillo del índice
